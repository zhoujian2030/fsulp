...
TEST_F(TestResCleaner, Basic_Test) {
    ...
    for (i=0; i<10; i++) {
        ...
        pRlcCtxArray[i]->idleCount = gMaxIdleCount - 10 + i;
    ...
    usleep(100000);
    for (i=0; i<10; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 9 + i);
    }
    ASSERT_EQ(RlcGetUeContextCount(), 10);
    ...
    usleep(100000);
    for (i=0; i<9; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 8 + i);
    }
    ...
    usleep(100000);
    for (i=0; i<8; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 7 + i);
    }
    ...
    usleep(100000);
    for (i=0; i<7; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 6 + i);
    }
    ...
    usleep(100000);
    for (i=0; i<6; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 5 + i);
    }
    ...
    usleep(100000);
    for (i=0; i<5; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 4 + i);
    }
    ...
    usleep(100000);
    for (i=0; i<4; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 3 + i);
    }
    ...
    usleep(100000);
    for (i=0; i<3; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 2 + i);
    }
    ...
    usleep(100000);
    for (i=0; i<2; i++) {
        ASSERT_EQ(pRlcCtxArray[i]->idleCount, gMaxIdleCount - 1 + i);
    }
    ...
    NotifyResCleaner();
    usleep(100000);
    ASSERT_EQ(pRlcCtxArray[0]->idleCount, gMaxIdleCount);
